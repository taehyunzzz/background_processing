...
{	
	...
	string img_list_path = "C:/Users/Taehyun Kim/Desktop/Project/3.Background_Subtraction/target.txt";
	string base_bg_dir = "";
	string write_path = "C:/Users/Taehyun Kim/Desktop/input/";
...
void processList3(string img_list_path, string random_bg_list_path, string write_path) {
	...
	while (getline(img_list, img_path)) {
		...
		while (getline(random_bg_list, random_bg_path) && bg_cnt < 200) {
